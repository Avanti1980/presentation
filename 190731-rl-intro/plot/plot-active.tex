...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    %\draw[very thick][loosely dotted] (2.5,0) ellipse (2 and 3);
    %\draw[very thick][loosely dotted] (-2.5,0) ellipse (2 and 3);

    \draw[very thick][red] (-3.5,1) circle (0.1); % 初始
    \draw[very thick] (-2.5,2) circle (0.1);
    \draw[very thick] (-2,1.2) circle (0.1);

    \draw[very thick] (-2.3,-0.3) circle (0.1);
    \draw[very thick] (-2.5,-2) circle (0.1);
    \draw[very thick] (-2,-1) circle (0.1);
    \draw[very thick][red] (-1,-0.5) circle (0.1);

    \draw[very thick] (2.6,1.5) circle (0.1);
    \draw[very thick] (3.2,0.8) circle (0.1);

    \draw[very thick][blue] (1,0.5) circle (0.1); % 初始
    \draw[very thick] (2,0) circle (0.1);
    \draw[very thick] (2.5,-0.2) circle (0.1);

    \draw[very thick] (2.9,-1.5) circle (0.1);
    \draw[very thick][blue] (2.4,-2) circle (0.1);

    %\draw[very thick][loosely dashed] (-1,-0.5) -- (1.14, 0.64);
    %\draw[very thick][loosely dashed] (-2.3,-0.3) -- (2.64, -0.06);

    \draw[dashed] (-1.2,2) -- (1.05, -2);
    %\path (-1.2,2) node[draw=none,right] () {$\surd$};

    %\draw[dashed] (-3.3,1.6) -- (3.1, -1.9);
