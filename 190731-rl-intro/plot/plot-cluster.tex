...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    %\draw[loosely dotted,very thick] (2.5,0) ellipse (2 and 3);
    %\draw[loosely dotted,very thick] (-2.5,0) ellipse (2 and 3);

    %\path (-1.3,2.5) node[draw=none,above,very thick] () {};
    ...
    \draw[very thick] (-1,-0.5) circle (0.1);
    ...
    %\draw[loosely dashed,very thick] (-1,-0.5) -- (1.14, 0.64);
    %\draw[loosely dashed,very thick] (-2.3,-0.3) -- (2.64, -0.06);

    %\draw[very thick] (-1.2,2.454) -- (1.35, -2.5);
