...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    \draw[->,>=stealth] (-4,-3)--(4,-3);
    \draw[->,>=stealth] (-3.5,-3.5)--(-3.5,3);

    %\draw[->,>=stealth] (-3,-2.2)--(3,1.8);

    \draw[very thick] (-2.5,-1.8) circle (0.1);
    \draw[very thick] (-2,-1.5) circle (0.1);
    \draw[very thick] (-1,-0.8) circle (0.1);

    \draw[very thick] (2.6,1.5) circle (0.1);
    \draw[very thick] (1.8,0.95) circle (0.1);
