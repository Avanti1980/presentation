...
由$\lambda \xi_i = m \alpha_i$、$\lambda \nu \epsilon_i = m \beta_i$可得$\epsilon_i$、$\xi_i$，由下式可得$\wv_1, \ldots, \wv_{|\Bcal|}$
...
<div class="rand top2 head-highlight-1 tr-hover">
