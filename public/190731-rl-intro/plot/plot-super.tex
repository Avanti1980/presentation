...
\tikzset{elegant/.style={smooth,very thick,samples=200,black}}
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    %\path (-1.3,2.5) node[draw=none,above] () {};
    \draw[red,very thick] (-3.5,1) circle (0.1);
    \draw[red,very thick] (-2.5,2) circle (0.1);
    \draw[red,very thick] (-2,1.2) circle (0.1);

    \draw[red,very thick] (-2.3,-0.3) circle (0.1);
    \draw[red,very thick] (-2.5,-2) circle (0.1);
    \draw[red,very thick] (-2,-1) circle (0.1);
    \draw[red,very thick] (-1,-0.5) circle (0.1);

    \draw[blue,very thick] (2.6,1.5) circle (0.1);
    \draw[blue,very thick] (3.2,0.8) circle (0.1);

    \draw[blue,very thick] (1,0.5) circle (0.1);
    \draw[blue,very thick] (2,0) circle (0.1);
    \draw[blue,very thick] (2.5,-0.2) circle (0.1);

    \draw[blue,very thick] (2.9,-1.5) circle (0.1);
    \draw[blue,very thick] (2.4,-2) circle (0.1);
